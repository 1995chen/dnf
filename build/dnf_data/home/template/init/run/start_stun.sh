...
# 清理cfg文件
rm -rf /tmp/stun.cfg
echo "compiling stun_hook.so..."
gcc -shared -fPIC -o stun_hook.so stun_hook.c -ldl -Wall -O2
chmod +x stun_hook.so
echo "starting stun..."
LD_PRELOAD=/home/neople/stun/stun_hook.so ./df_stun_r start
netstat -tulpn | grep stun
sleep 2
