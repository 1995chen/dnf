...
rm -rf /tmp/dbmw_mnt.cfg
# 生成tbl文件
rm -rf /tmp/dbmw_mnt_server_config.tbl
rm -rf /home/neople/dbmw_mnt/table/server_config.tbl
cp /home/template/neople/dbmw_mnt/table/server_config.tbl /tmp/dbmw_mnt_server_config.tbl
sed -i "s/SERVER_GROUP/$SERVER_GROUP/g" /tmp/dbmw_mnt_server_config.tbl
sed -i "s/PUBLIC_IP/$MONITOR_PUBLIC_IP/g" /tmp/dbmw_mnt_server_config.tbl
cp /tmp/dbmw_mnt_server_config.tbl /home/neople/dbmw_mnt/table/server_config.tbl
# 清理tbl文件
rm -rf /tmp/dbmw_mnt_server_config.tbl
